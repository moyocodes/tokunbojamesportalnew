			...
			<div className="ltn__header-top-area section-bg-6 top-area-color-white---">
				...
				<div className="row">
					...
					<div className="ltn__top-bar-menu">
						<ul>
						<li><a href="mailto:tokunbojames@yahoo.com"><i className="icon-mail" />tokunbojames@yahoo.com</a></li>
						<li><a href="https://maps.app.goo.gl/DReTbwvEuxxU8XAo8"><i className="icon-placeholder" target="_self" />Tolani’s Ajanla Street, Off Obafemi Awolowo way, Oke-Ado, Ibadan.</a></li>
						</ul>
					</div>
					</div>
				...
				<div className="row">
					...
					<div className="header-menu d-none d-xl-block">
						...
						<div className="ltn__main-menu go-top">
							...
							<li className="menu-icon"><Link to="service">Service</Link></li>
							...
							<li className="menu-icon"><Link to="team">Team</Link></li>
							<li className="menu-icon"><Link to="faq">FAQ</Link></li>
