              ...
              <div className="row">
                <div className="col-md-7">
                  <div className="ltn__top-bar-menu">
                    <ul>
                      <li>
                        <a href="mailto:info@tokunbojames.com?Subject=Flower%20greetings%20to%20you">
                          <i className="icon-mail" /> info@tokunbojames.com
                        </a>
                      </li>
                      <li>
                        <a href="#map">
                          <i className="icon-placeholder" /> 162b Obafemi
                          Awolowo way, oke ado.
                        </a>
                      </li>
                    </ul>
                  ...
                  <div className="site-logo-wrap">
                    ...
                    <div className="get-support clearfix d-none">
                      ...
                      <div className="get-support-info">
                        <h6>Get Support</h6>
                        <h4>
                          <a href="tel:+234 8036215324">+234 8036215324</a>
                        </h4>
                      </div>
                    </div>
                  </div>
