    ...
    return <div className="ltn__team-area pt-115 pb-90 go-top">
				...
				<div className="row justify-content-center">
					...
					<div className="ltn__team-item ltn__team-item-3---">
						...
						<img src={publicUrl+"assets/img/team/tk.jpeg"} alt="Image" />
						</div>
						<div className="team-info">
						<h4><Link to="#">Tokunbo James</Link></h4>
					...
					<div className="ltn__team-item ltn__team-item-3---">
						...
						<div className="team-info">
						<h4><Link to="#">Mr Sherrif</Link></h4>
						<h6 className="ltn__secondary-color">Property Seller</h6>
						<div className="ltn__social-media">
							<ul>
							<li><a href="#"><i className="fab fa-facebook-f" /></a></li>
							<li><a href="#"><i className="fab fa-twitter" /></a></li>
							<li><a href="https://www.linkedin.com/in/tokunbo-james-82686b38"><i className="fab fa-linkedin" /></a></li>
							</ul>
						</div>
						</div>
					</div>
